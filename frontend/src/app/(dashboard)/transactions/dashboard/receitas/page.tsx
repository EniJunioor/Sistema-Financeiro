    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Gerencie e acompanhe todas as suas receitas</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="border border-gray-200 hover:shadow-md transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-gray-700">Total de Receitas</CardTitle>
          ...
          <CardContent>
            ...
            <div className="flex items-center gap-1 mt-2">
              <span className={`text-sm ${incomeChange >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                {formatPercentage(incomeChange)} vs mês anterior
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border border-gray-200 hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">{formatCurrency(thisMonthIncome)}</div>
            <p className="text-xs text-gray-500 mt-2">Receitas do mês atual</p>
          </CardContent>
        </Card>
        ...
        <Card className="border border-gray-200 hover:shadow-md transition-shadow">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-gray-900">{formatCurrency(averageIncome)}</div>
      ...
      <Card className="border border-gray-200">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-gray-900">Lista de Receitas</CardTitle>
